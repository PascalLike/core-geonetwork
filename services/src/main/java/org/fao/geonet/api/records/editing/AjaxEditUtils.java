...
public class AjaxEditUtils extends EditUtils {
    ...
    public synchronized Element addElementEmbedded(UserSession session, String id, String ref, String name, String childName) throws Exception {
        ...
        //--- Do custom processing of the element to add, by the schema plugin if required
        SchemaPlugin plugin = dataManager.getSchema(schema).getSchemaPlugin();
        plugin.processElementToAdd(childName, child);
